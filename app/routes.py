...
def index():
    ...
    if form.validate_on_submit():
        ...
        cmd_string, pattern_string, resp_string = ctrl.control(command)
        zh_string = ""
        for k in CMD_LIST:
            if k[0] == cmd_string:
                zh_string = k[1]
        ...
        print(cmd_string)
        return render_template('index.html', title='Intention Demo', form=form, cmd=cmd_string, cmd_list=CMD_LIST, suggestions=suggestions, resp_string=resp_string)
    return render_template('index.html', title='Intention Demo', form=form, cmd="", cmd_list=CMD_LIST, suggestions=suggestions, resp_string=resp_string)
